...
GMPI_REGISTER_GUI(MP_SUB_TYPE_GUI2, ImageXGui, L"ImageX");
SE_DECLARE_INIT_STATIC_FILE(ImageX_Gui);

ImageXGui::ImageXGui(bool useMouseResponsePin) :
...
int ImageXGui::getMouseResponse()
{
...
int32_t ImageXGui::onMouseWheel(int32_t flags, int32_t delta, GmpiDrawing_API::MP1_POINT point)
{
...
int32_t ImageXGui::measure(GmpiDrawing_API::MP1_SIZE availableSize, GmpiDrawing_API::MP1_SIZE* returnDesiredSize)
{
	if (!bitmap_.isNull())
	{
