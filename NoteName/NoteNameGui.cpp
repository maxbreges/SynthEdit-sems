...
public:
	PitchDisplayGui()
	{
		...
		initializePin(pinPitch, static_cast<MpGuiBaseMemberPtr2>(&PitchDisplayGui::onSetPitchIn));
		initializePin(pinNoteOff, static_cast<MpGuiBaseMemberPtr2>(&PitchDisplayGui::onSetPitchIn));
	}
...
namespace
{
	auto r = Register<PitchDisplayGui>::withId(L"NoteName");
}
