//Pin Count example as Text Append
#include "mp_sdk_gui2.h"

using namespace std;
using namespace gmpi;

class PinCountGui final : public SeGuiInvisibleBase
{
	void onSetPinCount()
	{
		// pinTextIn changed
...
public:
	PinCountGui()
	{
		initializePin(pinPinCount, static_cast<MpGuiBaseMemberPtr2>(&PinCountGui::onSetPinCount));
		initializePin( pinTextOut, static_cast<MpGuiBaseMemberPtr2>(&PinCountGui::onSetTextOut) );
	}
    ...
    int32_t initialize() override
    {
        ...
        try
        {
            ...
            {
                initializePin(pinTextIn[i], static_cast<MpGuiBaseMemberPtr2>(&PinCountGui::onSetTextIn));
            }
        }
...
namespace
{
	auto r = Register<PinCountGui>::withId(L"PinCountGui");
}
