...
class JustFolderListGui final : public SeGuiInvisibleBase
{
...
public:
    JustFolderListGui()
    {
        initializePin(pinTrigger, static_cast<MpGuiBaseMemberPtr2>(&JustFolderListGui::onSetTrigger));
        initializePin(pinDirectory, static_cast<MpGuiBaseMemberPtr2>(&JustFolderListGui::onSetDirectory));
