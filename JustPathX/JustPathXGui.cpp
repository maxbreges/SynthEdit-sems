...
class JustPathXGui final : public SeGuiInvisibleBase
{
...
public:
    JustPathXGui()
    {
        initializePin(pinTrigger, static_cast<MpGuiBaseMemberPtr2>(&JustPathXGui::onSetTrigger));
        initializePin(pinDirectory, static_cast<MpGuiBaseMemberPtr2>(&JustPathXGui::onSetDirectory));
...
namespace
{
    auto r = Register<JustPathXGui>::withId(L"JustPathX");
}